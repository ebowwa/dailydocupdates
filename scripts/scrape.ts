...
function generateMarkdown(report: DailyReport): string {
  ...
  let md = `# Daily Doc Updates - ${report.date}\n\n`;
  ...
  // Footer
  md += `---\n`;
  md += `*Generated by [dailydocupdates](https://github.com/ebowwa/dailydocupdates) daily automation*\n`;
  md += `*Data sourced from [anthropics/claude-code](https://github.com/anthropics/claude-code), [code.claude.com](https://code.claude.com/docs), [platform.claude.com](https://platform.claude.com), and [docs.polymarket.com](https://docs.polymarket.com)*\n`;
